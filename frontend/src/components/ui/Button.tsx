...
export default function Button({
  ...
  const variants = {
    primary: "bg-bou-500 text-white hover:bg-bou-600 focus:ring-bou-500",
    secondary: "bg-bou-gold text-bou-900 hover:bg-bou-gold-light focus:ring-bou-gold",
    outline: "border-2 border-bou-500 text-bou-500 hover:bg-bou-50 focus:ring-bou-500",
